<template>
  <v-container fluid class=" px-2">
    <v-row justify="center" align="center">
      <v-col v-for="item in youtube" :key="item.day" md="6" sm="6" cols="12">
        <div
          class="pa-2"
          style="
...
export default {
  data: () => ({
    youtube: [
      {
        day: "#IWDIndia2021​ | Day 1",
        date: "March 20",
        type: "Watch Now",
        link: "https://bit.ly/iwdindia01",
        time: "03:00 PM - 07:00 PM (IST)",
        img: "https://img.youtube.com/vi/si9x1XuEDKc/mqdefault.jpg",
      },
      {
