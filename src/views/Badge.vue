<template>
  <v-main>
    <v-container fluid class="mb-5">
      ...
      <v-row justify="center" align="center" class="pa-0 my-0 mb-md-15">
        <v-col md="10" lg="10" sm="11" cols="12" class="pa-0 ma-0">
          <v-container fluid class="pa-0 ma-0">
            <v-row class="ma-0 pa-0">
              <v-col md="3" cols="12" class="order-md-1 order-2 pt-md-10 px-7">
                <div class="input">
                  <label class="google-font" style="font-size:120%">Profile Picture</label>
                  <v-btn class="primary google-font" depressed large @click="uploadImage()" style="text-transform: capitalize;">
                    Upload Image
                  </v-btn>
                  <input
                    class="profile-input"
                ...
                <div class="input">
                  <label class="google-font" style="font-size:120%">Image Shape</label>
